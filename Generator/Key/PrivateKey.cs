...
namespace Generator.Key
{
    ...
    public class PrivateKey : VersionedChecksummedBytes
    {
            ...
            : base(wifEncoded)
        {
            ...
            {
                throw new Exception($"Mismatched version number, trying to cross networks? {Version} vs {version[0]}");
            }
        }
        ...
        public static PrivateKey CreatePrivateKey(byte[] keyByte, byte[] networkVersion, bool compressedPublicKey=true)
        {
            return new PrivateKey(networkVersion, keyByte, compressedPublicKey);
        }
